...
router.get('/collectons',adminControllers.collections)
...
router.get('/delete_p/:id', adminControllers.delete)
router.get('/delete_c/:id', adminControllers.delete) /*eliminar recursos del servidor*/
