...
-- insert role
INSERT INTO `funko_test`.`role` (`role_id`, `role_name`) VALUES ('1', 'admin'),('2', 'user');

-- insert users
INSERT INTO `funko_test`.`user` (`name`, `lastname`, `email`, `password`, `create_time`) VALUES 
...
-- insert role user
INSERT INTO `funko_test`.`user_has_role` (`user_user_id`, `role_role_id`) VALUES 
('1', '1'),
('2', '1'),
('3', '2'),
('4', '2'),
...
-- insert naruto prod
INSERT INTO `funko_test`.`product` (`product_name`, `product_description`, `price`, `stock`, `discount`, `sku`, `dues`, `image_front`, `image_back`, `create_time`, `licence_id`, `category_id`) VALUES 
('Naruto Uzumaki sage mode', 'Figura coleccionable de Naruto Uzumaki modo sage', '1999.99', '8', '10', 'NAR001001', '3', '/img/naruto/naruto-sage-mode-1.webp', '/img/naruto/naruto-sage-mode-box.webp', '2023-06-27 23:33:21', '4', '1'),
('kurama', 'Figura coleccionable de Kurama, zorro de nueve colas', '2199.99', '8', '10', 'NAR001002', '3', '/img/naruto/kurama-1.webp', '/img/naruto/kurama-box.webp', '2023-06-27 23:33:21', '4', '1'),
('Sasuke Uchiha', 'Figura coleccionable de Sasuke Uchiha', '1799.99', '8', '10', 'NAR001003', '3', '/img/naruto/sasuke-1.webp', '/img/naruto/sasuke-box.webp', '2023-06-27 23:33:21', '4', '1');

-- insert naruto
INSERT INTO `funko_test`.`licence` (`licence_id`, `licence_name`, `licence_description`, `licence_image`) VALUES ('4', 'Naruto', 'Desata el poder ninja en tu coleccion.', 'img/naruto/nar-cover.jpg');
